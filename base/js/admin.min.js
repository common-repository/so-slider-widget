...
for(var i in iconWidgetCache[family]['icons']){var icon=$('<div data-sow-icon="'+iconWidgetCache[family]['icons'][i]+'"/>').attr('data-value',family+'-'+i).addClass('sow-icon-'+family).addClass('siteorigin-widget-icon-icons-icon').click(function(){console.log('here');var $$=$(this);if($$.hasClass('siteorigin-widget-active')){$$.removeClass('siteorigin-widget-active');$v.val('');}
